...
export const C = {
  ar: {
    ...
    hero: {
      ...
      titleLines: ["مصمـمة منتجات", "رقميـة تتمحـور", "حــول المستخدم"],
  ...
  en: {
    ...
    hero: {
      ...
      titleLines: ["User-Centered", "Product Designer"],
...
export const PROJECTS = [
  {
    ...
    coverDark: "/images/mishkat/cover-dark.png",
    ...
    ar: {
      ...
      tools: "Figma, Flutter",
      meta: [["التصنيف", "مشروع تخرج"], ["المدة", "سبتمبر 2025 – يونيو 2026"], ["الفريق", "6 أعضاء"], ["الأدوات", "Figma، Flutter"]],
      ...
      problem: [
        ...
        "وأظهر البحث أن الخصوصية والوصمة كانتا أكبر حاجزين أمام التبنّي: من أصل 287 مشاركًا في الاستبيان، 74 فقط سبق لهم استخدام تطبيق للصحة النفسية أو التأمل.",
      ],
      ...
      role_note: "ضمن فريق من 6 أعضاء، شاركت في معظم مراحل تجربة المستخدم:",
      ...
      steps: [
        ["البحث", "مقابلات شبه منظمة مع 15 طالبة موهوبة، واستبيان بـ287 استجابة، وتحليل مقارن للتطبيقات المشابهة كشف غياب حل يجمع بين الجمهور الموهوب، العربية وRTL، والدعم داخل السياق المدرسي."],
        ...
        ["التقييم", "جولتان من اختبار قابلية الاستخدام على النموذج، ثم جولة ثالثة على النظام المنفّذ فعليًا مع 6 مستخدمات من الفئة المستهدفة، بأسلوب التفكير بصوت عالٍ، وسيناريوهات واقعية، ومقابلات ختامية."],
      ],
      metrics: [
        ["68% ← 92%", "معدل إتمام المهام بين جولتَي التقييم"],
        ["2.4 ← 1.3 دقيقة", "متوسط زمن إتمام المهمة"],
        ["6 من 6", "أكملن كل السيناريوهات دون تدخل"],
      ],
  ...
  },
  {
    ...
    coverDark: "/images/easypay/cover-dark.png",
    ...
    ar: {
      ...
      tools: "Figma",
      meta: [["التصنيف", "خبرة"], ["الجهة", "EasyPay — مكة"], ["المدة", "مارس – يوليو 2025"], ["الأدوات", "Figma"]],
      ...
      metrics: [
        ["4", "مكتبات مكوّنات مسلَّمة"],
        ["5", "أجهزة خضعت للتحليل"],
        ["5 أشهر", "مدة العمل داخل فريق التصميم"],
      ],
